...
class fastgltf(ConanFile):
    ...
    options = {
        ...
        "enable_deprecated_ext": [True, False],
    ...
    def generate(self):
        ...
        if self.options.get_safe("enable_deprecated_ext"):
            tc.variables["FASTGLTF_ENABLE_DEPRECATED_EXT"] = True
